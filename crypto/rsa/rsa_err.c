...
static ERR_STRING_DATA RSA_str_functs[] = {
    ...
    {ERR_FUNC(RSA_F_MARSHAL_INTEGER), "marshal_integer"},
    {ERR_FUNC(RSA_F_OLD_RSA_PRIV_DECODE), "old_rsa_priv_decode"},
    {ERR_FUNC(RSA_F_PARSE_PUBLIC_KEY), "parse_public_key"},
    ...
    {ERR_FUNC(RSA_F_RSA_MARSHAL_PRIVATE_KEY), "RSA_marshal_private_key"},
    {ERR_FUNC(RSA_F_RSA_MARSHAL_PUBLIC_KEY), "RSA_marshal_public_key"},
    ...
    {ERR_FUNC(RSA_F_RSA_PARSE_PRIVATE_KEY), "RSA_parse_private_key"},
    {ERR_FUNC(RSA_F_RSA_PRINT), "RSA_print"},
    {ERR_FUNC(RSA_F_RSA_PRINT_FP), "RSA_print_fp"},
    {ERR_FUNC(RSA_F_RSA_PRIVATE_KEY_FROM_BYTES),
     "RSA_private_key_from_bytes"},
    {ERR_FUNC(RSA_F_RSA_PRIVATE_KEY_TO_BYTES), "RSA_private_key_to_bytes"},
    {ERR_FUNC(RSA_F_RSA_PRIV_ENCODE), "rsa_priv_encode"},
    {ERR_FUNC(RSA_F_RSA_PSS_TO_CTX), "rsa_pss_to_ctx"},
    {ERR_FUNC(RSA_F_RSA_PUBLIC_KEY_FROM_BYTES), "RSA_public_key_from_bytes"},
    {ERR_FUNC(RSA_F_RSA_PUBLIC_KEY_TO_BYTES), "RSA_public_key_to_bytes"},
...
static ERR_STRING_DATA RSA_str_reasons[] = {
    ...
    {ERR_REASON(RSA_R_BAD_ENCODING), "bad encoding"},
    {ERR_REASON(RSA_R_BAD_E_VALUE), "bad e value"},
    {ERR_REASON(RSA_R_BAD_FIXED_HEADER_DECRYPT), "bad fixed header decrypt"},
    {ERR_REASON(RSA_R_BAD_PAD_BYTE_COUNT), "bad pad byte count"},
    {ERR_REASON(RSA_R_BAD_RSA_PARAMETERS), "bad rsa parameters"},
    {ERR_REASON(RSA_R_BAD_SIGNATURE), "bad signature"},
    {ERR_REASON(RSA_R_BAD_VERSION), "bad version"},
    ...
    {ERR_REASON(RSA_R_ENCODE_ERROR), "encode error"},
